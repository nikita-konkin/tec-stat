...
def stations_with_meta(
    ...
    return list_stations_with_meta(year, doy, settings.get_tec_root(data_root))
...
def satellites(
    ...
    return list_satellites(year, doy, station, settings.get_tec_root(data_root))
...
def satellite_data(
    ...
    return get_tec_data(year, doy, station, satellite, settings.get_tec_root(data_root))
